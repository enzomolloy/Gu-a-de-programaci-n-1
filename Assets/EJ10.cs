//10. Realizá un programa que resuelva el siguiente problema: Nos piden desarrollar un  programa que informe si un 
...
//e informar por  pantalla mediante la misma si el estacionamiento se encuentra abierto o no.Obs: 
//En el caso de que el valor de la variable correspona a una hora menor a 0 o mayor a 24, mostrar el  mensaje: 
...
public class EJ10 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            estaAbierto = true;
            Debug.Log("Estacionaminto abierto: " + estaAbierto);
        }
        else
        {
            estaAbierto = false;
